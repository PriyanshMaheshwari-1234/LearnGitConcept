...
Feature: MACD Scenarios on notification and sms verification for Migrated HSI Postpaid accounts 

#Prathibha script
@ATC_MACD_11.1
    Scenario Outline: MACD Scenario on H S I during  CH  add POTS and SMS verification 11.1
    ...
    And I modify phone number "<contactNumber>"
    Then Take a ScreenShot "<scen>"
    ...
    Examples: 
    | Environment   | Env | firstName | lastName | phoneNo    |account number| address                                  | Date | Month | Year | contactNumber | zip code | Ease_Option | Voice Mail | Wire Maintenance Plan | Port in a phone number? | Need new jacks or wiring? |scen           |filelocation1                                            |TCID|
    | Test2         | E2E | Jones     | Smith    | 4029986730 |690087855     | 1693 GARFIELD AVE, DUBUQUE, IA,52001,USA | 02   |    02 | 1987 | 6666012834    | No       | BASIC       | No         | No                    | No                      |  No Work Is Needed ($0/mo)|ATC_MACD_11.1  |../EshopTools/Database_Validation/Database_Scenario.xlsx |1.6 |
 

 #Prathibha Script
     @ATC_MACD_11.2 
    Scenario Outline: MACD Scenario on H S I Speed Downgrade Same technology 11.2
    #Given I should be on SFC login screen
    #When I enter username and password
    #Below two commented steps are Future Ready steps for MACD Scenarios
    #Then I move back to existing SFC page
    ...
    Examples: 
    | Environment  | Env | firstName | lastName | phoneNo    |account number|  Date | Month | Year | SSN       | contactNumber| zip code | Ease_Option   |Select_speed               |Wire Maintenance Plan | Port in a phone number? | Need new jacks or wiring? |Installation_option  | Modem_Option           |scen           |filelocation1                                            |TCID|
    | Test2        | E2E | Jones     | Smith    | 4029986730 |690084443     |  02   |    02 | 1987 | 666601283 | 6666012834   |No        | Basic ($0/mo) |HSI Up to 30 Mbps/1.5 Mbps | No                   | No                      | No Work Is Needed ($0/mo) |Self Install ($0/mo) | Leased Modem ($15/mo)  |ATC_MACD_11.2  |../EshopTools/Database_Validation/Database_Scenario.xlsx |1.6 |
  
  
   #Prathibha Script
  @ATC_MACD_11.3
  Scenario Outline: MACD Scenario on H S I Speed Upgrade Different technology 11.3
    #Given I should be on SFC login screen
    #When I enter username and password
    #Below two commented steps are Future Ready steps for MACD Scenarios
    #Then I move back to existing SFC page
    ...
    | Test2        | E2E | Jones     | Smith    | 4029986730 |690087844     | 1693 GARFIELD AVE, DUBUQUE, IA,52001,USA | 02   |    02 | 1987 | 666601283 | 6666012834   |No        | Basic ($0/mo) |HSI Up to 80 Mbps/10 Mbps  | No                   | No                      | No Work Is Needed ($0/mo) |Self Install ($0/mo) | Leased Modem ($15/mo)|ATC_MACD_11.3  |../EshopTools/Database_Validation/Database_Scenario.xlsx |1.6 |
