...
Feature: MACD Scenarios for Move Add
  ...
  Scenario Outline: "ATC_MACD_14" HSI  during  Move add POTS
    ...
    Examples: 
      ...
      | E2E | Jones     | Smith    | 4029986730 | 611 FENWICK DR,PAPILLION,NE 68046,USA |      480025072 | STANDARD            | 2 devices       | No         | No                    | No                      | No Work Is Needed ($0)    |

  #ATC_MACD_15   account number = 473708391
  @MACD_HSI_MOVE_ADD_CVOIP_NOPAY
  Scenario Outline: "ATC_MACD_15" HSI  during  MV add CVOIP
    ...
    Examples: 
      ...
      | E2E | Jones     | Smith    | 4029986730 | 3066 SHADY LN , LITTLETON, CO, 80126 |      480025072 | STANDARD            | 2 devices       |
