package com.ctl.it.qa.eshop.tests.dataOperations;
...
public class ExcelOperations extends GlobalVariables {
	...
	public void setDataAsPerScenario(String data)
	...
	/*
	 * public void setDBAndEnvironmentValues(String environment) throws
