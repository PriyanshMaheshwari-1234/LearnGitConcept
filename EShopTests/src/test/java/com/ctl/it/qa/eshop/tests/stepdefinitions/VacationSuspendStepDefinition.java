...
import com.ctl.it.qa.eshop.steps.VacationSuspendSteps;
...
public class VacationSuspendStepDefinition {
	...
	public void i_validate_if_Vacation_options_tab_is_displayed_with_referral_message_options_with_defaulted_in_drop_down(
			String value) {
	...
	public void i_See_Suspend_Restore_Page() {
		vacationSuspendUser.i_See_Suspend_Restore_Page();
	}

	@Then("^I Click on Suspend All for entire Ban$")
	public void i_click_on_suspendAll_for_entire_ban() {
		vacationSuspendUser.i_Click_On_SuspendAll();
	}

	@Then("^I click on Submit Button on Suspend and Restore Page$")
	public void i_click_on_Submit_Button_on_Suspend_Restore_Page() {
		vacationSuspendUser.i_Click_On_Submit_On_Suspend_Restore_Page();
	}

	//Priyansh added
	@Then("^I click continue on Product and service page$")
	public void i_click_continue_on_Product_and_service_page() {
		vacationSuspendUser.clickContinueOnPage();
	}
