...
import com.ctl.it.qa.eshop.steps.DisconnectSteps;
...
public class DisconnectStepDefinition {
	...
	// Swati Added step defination

	@And("^I click on continue button on Scheduling page of Disconnect Order$")
	public void i_click_on_continue_button_on_Scheduling_page_of_Disconnect_Order() throws Throwable {

		disconnectsteps.clickoncontinueonschedulingpageofdisconnectorder();
