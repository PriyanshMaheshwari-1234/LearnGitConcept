...
public class VacationRestorePage extends Page {
	...
	//created by Sachin
		@FindBy(xpath = "//span[contains(text(),'Suspended')]")
		public WebElementFacade BeforeOpHSIStatus;
		
		//created by Sachin
		@FindBy(xpath = "//p[@class='ng-star-inserted'] //button[contains(text(),'Restore All')]")
		public WebElementFacade ClickOnRestoreAll;
		
		//created by Sachin
		@FindBy(xpath = "//span[contains(text(),'Ready to Restore')]")
		public WebElementFacade AfterOpHSIStatus;
