...
public class VacationSuspendPage extends Page{
	...
	@FindBy(xpath = "//a[@class='tab-order-flow tab-order-active']")
	public WebElementFacade SuspendRestorePageTittle;
	
	@FindBy(xpath = "//button[contains(text(),'Suspend All')]")
	public WebElementFacade ClickOnSuspendAll;
	//p[contains(text(),'Active')]
	
	@FindBy(xpath = "//p[contains(text(),'Active')]")
	public WebElementFacade BeforeOpBanStatus;
	
	@FindBy(xpath = "//p[contains(text(),'Ready to Suspend')]")
	public WebElementFacade AfterOpBanStatus;
	...
	@FindBy(xpath = "//button[contains(text(),'Submit updates')]")
	public WebElementFacade ConfirmSubmitButton;
	
	//Priyansh added
	@FindBy(xpath="//h3[text()='Products & Services']")
	public WebElementFacade prodAndServ;
	
	@FindBy(xpath="//button[contains(text(),'Continue')]")
	public WebElementFacade prodAndServContinue;
