...
//	public static String testDataFilePath=new File("src/test/resources/testData").getAbsolutePath();
//	public static File ExcelFile = new File(testDataFilePath+"\\TestDataSheet.xlsx");
	public static final String genericXMLFilePath="src/test/resources/XML_Files/";
...
//	public static String ex_BillingSystem;
//	public static String ex_CreditCardNumber;
//	public static String ex_SSN;
//	public static String ex_Date;
//	public static String ex_Month;
//	public static String ex_Year;
//	public static String ex_TechRemarks;
